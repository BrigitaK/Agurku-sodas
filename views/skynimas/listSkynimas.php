...
<div class="form-top agurkas">
    ...
    <?php if ($agurkas->count != 0) { ?>
        <div class="skinti-input">
            ...
            <button class="btn-skinti-i skintiA" type="button" name="skintiA" value="<?= $agurkas->id ?>">Skinti</button>
        </div>
    <button class="btn-skinti skintiVisusA" type="button" name="skintiVisusA" value="<?= $agurkas->id ?>">Skinti visus</button>
    <input type="hidden" name="<?= $agurkas->count ?>">
<?php } ?>
</div>
<?php endforeach ?>